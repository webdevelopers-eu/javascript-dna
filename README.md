...
- [ ] Proto aliasing: `config = {'proto': 'Proto1=Proto1:v2', ...}` to allow inclusion different scripts with the same prototype names. Will install `Proto1` as `dna["Proto1:v2"]` and optionally multiple aliases `Proto1=Proto1:v2=Proto1:latest=Proto1`
