...
- [x] __Out-of-order API__ - with unique O3 API (Ozone API) you can call DNA methods in any order, define your needs before configuring the DNA, and even call DNA before it is loaded
